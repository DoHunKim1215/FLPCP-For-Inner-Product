...
#define Ch(x, y, z)                                                                                                    \
    ({                                                                                                                 \
        ...
        asm(".insn r4 0x33, 1, 0x3, %0, %2, %1, %3\n\t" : "=r"(r[0]) : "r"(xp[0]), "r"(yp[0]), "r"(zp[0]));            \
        asm(".insn r4 0x33, 1, 0x3, %0, %2, %1, %3\n\t" : "=r"(r[1]) : "r"(xp[1]), "r"(yp[1]), "r"(zp[1]));            \
        ret;                                                                                                           \
    })
#define Maj(x, y, z)                                                                                                   \
    ({                                                                                                                 \
        ...
        const unsigned int* yp = (const unsigned int*)(&(y));                                                          \
        const unsigned int* zp = (const unsigned int*)(&(z));                                                          \
        asm(".insn r4 0x33, 1, 0x3, %0, %2, %1, %3\n\t" : "=r"(r[0]) : "r"(xp[0] ^ zp[0]), "r"(yp[0]), "r"(zp[0]));    \
        asm(".insn r4 0x33, 1, 0x3, %0, %2, %1, %3\n\t" : "=r"(r[1]) : "r"(xp[1] ^ zp[1]), "r"(yp[1]), "r"(zp[1]));    \
        ret;                                                                                                           \
    })
...
#define Ch(x, y, z)                                                                                                    \
    ({                                                                                                                 \
        SHA_LONG64 ret;                                                                                                \
        asm(".insn r4 0x33, 1, 0x3, %0, %2, %1, %3" : "=r"(ret) : "r"(x), "r"(y), "r"(z));                             \
        ret;                                                                                                           \
    })
#define Maj(x, y, z)                                                                                                   \
    ({                                                                                                                 \
        SHA_LONG64 ret;                                                                                                \
        asm(".insn r4 0x33, 1, 0x3, %0, %2, %1, %3" : "=r"(ret) : "r"(x ^ z), "r"(y), "r"(x));                         \
        ret;                                                                                                           \
    })
#endif
